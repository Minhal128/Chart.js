...
describe('Plugin.Tooltip', function() {
  ...
  it('should not run the callbacks or show the tooltip when the filter removes every item', async function() {
    var titleCallbackArgs = null;
    var chart = window.acquireChart({
      type: 'line',
      data: {
        datasets: [{
          ...
          tooltip: {
            ...
            callbacks: {
              title: function(tooltipItems) {
                titleCallbackArgs = tooltipItems;
                return 'title';
              }
            }
          }
    ...
    expect(titleCallbackArgs).toBe(null);
